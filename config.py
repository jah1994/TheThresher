...
#out_path = '/media/jah94/Seagate_Expansion_Drive#2/Synthetic LI spool/bessel/'
...
out_path = '/media/jah94/Seagate_Expansion_Drive#2/Synthetic LI spool/RealData/bessel/' # where to save plots and scene estimates
